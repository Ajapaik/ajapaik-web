...
class Command(BaseCommand):
    ...
    def _get_filtered_data_for_frontpage(self, album_id=None, page_override=None):
        starttime = time.time()
...
#            photos = photos.filter(albums__in = sa_ids)
            photos = photos.prefetch_related('albumphoto').filter(albumphoto__album__in= sa_ids)
...
#        print(str(photos.estimated_count()) + "\t" + str(photos.count()) + "\t" +str(photos.estimated_count()-photos.count()))
#        albumsize_before_sorting=photos.distinct().count()
##        albumsize_before_sorting=Photo.objects.filter(pk__in=photos).count()
        ...
        if order1 == 'closest' and lat and lon:
            ...
            if order2 == 'comments':
                if order3 == 'reverse':
                    ...
                    photos = photos.order_by('-comment_count')
                photos_with_comments = self._get_estimated_count(photos.filter(comment_count__gt=0))
            elif order2 == 'rephotos':
                if order3 == 'reverse':
                    photos = photos.order_by('rephoto_count')
                else:
                    photos = photos.order_by('-rephoto_count')
                photos_with_rephotos = self._get_estimated_count(photos.filter(rephoto_count__gt=0))
            elif order2 == 'geotags':
                if order3 == 'reverse':
            ...
            if order2 == 'rephotos':
                ...
                photos_with_rephotos = self._get_estimated_count(photos.filter(first_rephoto__isnull=False))
        ...
        print(str(counter) + " az0: " + str((time.time() - starttime2))) 
        starttime2 = time.time()
        print(photos.only('id')[start:(end+page_size)].query)
...
#            blacklist_exists = Album.objects.filter(id=38516).exists()
#            if blacklist_exists:
#                exclude_photos = Album.objects.get(id=38516).photos.filter(pk__in=photos_ids[start:(end+page_size)]).all()
#                photos = photos.exclude(pk__in=exclude_photos).all()

        counter=counter+1
        print(photos.only('id').query)
        print(str(counter) + " a4: " + str((time.time() - starttime2))) 
        starttime2 = time.time()



        photos_ids = list(photos.values_list('id', flat=True))
        albumsize_before_sorting=len(numpy.unique(photos_ids))
        print(albumsize_before_sorting)  



        print(str(counter) + " az1: " + str((time.time() - starttime2))) 
        starttime2 = time.time()
        print(photos.only('id')[start:(end+page_size)].query)
        ...
        print(str(counter) + " az2: " + str((time.time() - starttime2))) 
        starttime2 = time.time()
        print(photos.only('id')[start:(end+page_size)].query)

#        photos=photos.filter(pk__in=photos_ids[start:(end+page_size)])


        counter=counter+1
        print(str(counter) + " a: " + str((time.time() - starttime2))) 
        starttime2 = time.time()
        print(photos.only('id').query)
#        print(photos.count())
#        if 1:
...
#        photos_ids = list(photos.values_list('id', flat=True).distinct()[start:(end+page_size)])
        ...
        if 0 and order1 == 'closest' and lat and lon:
...
#        print(photos.count())
        ...
        counter=counter+1
        print(str(counter) + " c: " + str((time.time() - starttime2))) 
        starttime2 = time.time()
...
#           exit()
        ...
        if 0 and order1 == 'time' and order2 == 'rephotos':
            photo_ids=photos[start:end].values_list('id', flat=True)
            photos=Photo.objects.filter(id__in=photo_ids).all()
            if order3 == 'reverse':
                photos = photos.order_by(F('first_rephoto').asc(nulls_last=True))
        ...
        counter=counter+1
        print(str(counter) + " d: " + str((time.time() - starttime2))) 
        starttime2 = time.time()
        ...
        print(photos.query)
        print(str(counter) + " e0: " + str((time.time() - starttime2))) 
        starttime2 = time.time()

        photos = [list(i) for i in photos]

        counter=counter+1
        print(str(counter) + " e1: " + str((time.time() - starttime2))) 
        starttime2 = time.time()
        ...
        counter=counter+1
        print(str(counter) + " e2: " + str((time.time() - starttime2))) 
        starttime2 = time.time()
        ...
        counter=counter+1
        print(str(counter) + " f: " + str((time.time() - starttime2))) 
        starttime2 = time.time()
    ...
    def handle(self, *args, **options):
        self._get_filtered_data_for_frontpage()

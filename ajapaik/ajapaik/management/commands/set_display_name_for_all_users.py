...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        profiles = Profile.objects.exclude(Q(first_name__isnull=True) & Q(last_name__isnull=True) & Q(google_plus_name__isnull=True) & Q(fb_name__isnull=True) & Q(google_plus_email__isnull=True))

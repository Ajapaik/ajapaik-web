...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        def get_historical_photo_qs(album):
        ...
        for a in albums:
            ...
            ### create all_photos_list from historical photos and add rephotos to it to keep backwards compatibility with older stats
            ###

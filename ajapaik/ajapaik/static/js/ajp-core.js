...
(function ($) {
    ...
    if (!$this.hasClass('ajp-minimap-confirm-geotag-button-done')) {
      ...
      if (window.isFrontpage) {
        _gaq.push([
          '_trackEvent',
          'Gallery',
          'Photo modal confirm location click',
        ]);
      } else if (window.isMapview) {
    ...
    function () {
      if (window.isFrontpage) {
        _gaq.push([
          '_trackEvent',
          'Gallery',
          'Photo modal CTA specify location click',
        ]);
      } else if (window.isMapview) {
        _gaq.push([
          '_trackEvent',
  ...
  window.loadPossibleParentAlbums = function (
    ...
    let url = window.curatorSelectableParentAlbumsURL;
    if (currentAlbumId) {
      url += currentAlbumId + '/';
    }
    $.ajax({
    ...
    function (e) {
      ...
      if (window.isFrontpage) {
        _gaq.push([
          '_trackEvent',
          'Gallery',
          'Photo modal specify location click',
        ]);
      } else if (window.isMapview) {

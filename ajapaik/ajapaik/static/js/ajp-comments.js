$(document).ready(function () {
  ...
  $('#ajp-comment-list').on(
    ...
    function (event) {
      var comment_id = $(event.target).data('comment-id');
      var all_reply_form_divs = $(
        '#ajp-comment-list div[class*="comment-reply-form-"]'
      );
      var reply_form_div = $(
        '#ajp-comment-list div[class~="comment-reply-form-' + comment_id + '"]'
      );
  ...
  $('#ajp-comment-list').on('click', 'a[data-action="edit"]', function (event) {
    var comment_id = $(event.target).data('comment-id');
    var all_edit_form_divs = $(
      '#ajp-comment-list div[class*="comment-edit-form-"]'
    );
    var edit_form_div = $(
      '#ajp-comment-list div[class~="comment-edit-form-' + comment_id + '"]'
    );

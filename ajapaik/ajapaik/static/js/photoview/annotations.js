...
function createAnnotationLabelPopoverContent(annotation, child, container) {
    ...
    fetch(request)
        ...
        if (data.user_id && data.user_name) {
            ...
            popoverContent.append(interpolate(gettext('ssAnnotation was added by %(profileLink)s'), { profileLink }, true));
        } else {
    ...
    objectAnnotations.forEach(function(annotation) {
        ...
        fetch(request)
            ...
            if (data.user_id && data.user_name) {
                ...
                popoverContent.append(interpolate(gettext('sssAnnotation was added by %(profileLink)s'), { profileLink }, true));
            } else {

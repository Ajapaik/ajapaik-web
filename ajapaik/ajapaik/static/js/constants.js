...
var constants = {
    ...
    elements: {
        ...
        SUBJECT_AGEGROUP_SUGGESTION_COMPONENT_ID: 'person-popover-agegroup-suggestion',
    ...
    translations: {
        annotations: {
            ...
            INFORM_HOW_TO_TAG_PART_1: gettext('Click the face of <b>'),
            INFORM_HOW_TO_TAG_PART_2: gettext('</b> and confirm it in the opening dialogue')
        },
        errors: {
        ...
        queries: {
            ...
            ADD_OBJECT_ANNOTATION_SUCCESS: gettext('Successfully added object annotation'),
            ...
            ADD_FACE_ANNOTATION_SUCCESS: gettext('Successfully added face annotation'),

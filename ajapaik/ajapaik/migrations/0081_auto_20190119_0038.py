    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.PositiveSmallIntegerField(
                choices=[(0, 'Curated'), (1, 'Favorites'), (2, 'Auto'), (3, 'Person')]),
        ),
        migrations.AlterField(
            model_name='albumphoto',
            name='type',
            field=models.PositiveSmallIntegerField(db_index=True, default=2,
                                                   choices=[(0, 'Curated'), (1, 'Re-curated'), (2, 'Manual'),
                                                            (3, 'Still'), (4, 'Uploaded')]),
        ),
        migrations.AlterField(
            model_name='photo',
            name='image',
            field=models.ImageField(verbose_name='Pilt', max_length=255, blank=True, null=True, upload_to='uploads',
        ...
        migrations.AlterField(
            model_name='video',
            name='cover_image',
            field=models.ImageField(blank=True, null=True, upload_to='videos/covers', width_field='cover_image_width',

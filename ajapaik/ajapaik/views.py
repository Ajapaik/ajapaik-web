...
def _get_filtered_data_for_frontpage(request, album_id=None, page_override=None):
    ...
    if filter_form.is_valid():
        ...
        rephotos_by_id = None
        if rephotos_by:
            rephotos_by_name = rephotos_by.get_display_name
            rephotos_by_id = rephotos_by.pk
        ...
        start, end, total, max_page, page = get_pagination_parameters(page, page_size, len(photos))
...
def me(request):
    return redirect('user', user_id=request.get_user().profile_id)

...
from ajapaik.ajapaik.models import Photo, Album, AlbumPhoto, Profile

# Direct SQL queries for gettings stats with reasonably speed. If possible, rewrite using Django ORM

...
import ajapaik.ajapaik_auth.views
import ajapaik.ajapaik_comments.views
import ajapaik.ajapaik_curator.views
import ajapaik.ajapaik_datings.views
import ajapaik.ajapaik_geotags.views
import ajapaik.ajapaik_leaderboard.views
import ajapaik.ajapaik_misc.views
import ajapaik.ajapaik_profile.api
import ajapaik.ajapaik_profile.views
import ajapaik.ajapaik_similar_photos.views
import ajapaik.ajapaik_upload.csv_import.views
import ajapaik.ajapaik_upload.rephoto.views
import ajapaik.ajapaik_upload.views
import ajapaik.ajapaik_video.views
...
urlpatterns = [
    ...
    path('difficulty-feedback/', ajapaik.ajapaik_geotags.views.difficulty_feedback, name='difficulty_feedback'),
    path('geotag/add/', ajapaik.ajapaik_geotags.views.geotag_add, name='geotag_add'),
    path('geotag/confirm/', ajapaik.ajapaik_geotags.views.geotag_confirm, name='geotag_confirm'),
    ...
    path('game/', ajapaik.ajapaik_geotags.views.game, name='game'),
    path('geotaggers-modal/<int:photo_id>/', ajapaik.ajapaik_geotags.views.geotaggers_modal,
         name='photo_geotaggers'),
    path('geotag/', ajapaik.ajapaik_geotags.views.game, name='game'),
    path('login-modal/', ajapaik.ajapaik_auth.views.login_modal, name='login_modal'),
    path('map/', views.mapview, name='map'),
    path('map/photo/<int:photo_id>/', views.mapview, name='map'),
    path('map/rephoto/<int:rephoto_id>/', views.mapview, name='map'),
    path('map/photo/<int:photo_id>/rephoto/<int:rephoto_id>/', views.mapview, name='map'),
    path('map-data/', views.map_objects_by_bounding_box, name='map_objects_by_bounding_box'),
    path('leaderboard/', ajapaik.ajapaik_leaderboard.views.leaderboard, name='leaderboard'),
    path('leaderboard/album/<int:album_id>/', ajapaik.ajapaik_leaderboard.views.leaderboard,
         name='album_leaderboard'),
    path('all-time-leaderboard/', ajapaik.ajapaik_leaderboard.views.all_time_leaderboard,
         name='all_time_leaderboard'),
    path('top50/', ajapaik.ajapaik_leaderboard.views.top50, name='top50'),
    path('top50/album/<int:album_id>/', ajapaik.ajapaik_leaderboard.views.top50, name='album_top50'),
    path('photo/<int:photo_id>/upload/', ajapaik.ajapaik_upload.rephoto.views.rephoto_upload,
         name='rephoto_upload'),
    ...
    path('photo-upload-modal/<int:photo_id>/', ajapaik.ajapaik_upload.views.photo_upload_modal,
    ...
    path('video/<int:video_id>/<slug:pseudo_slug>/', ajapaik.ajapaik_video.views.videoslug, name='videoslug'),
    path('video-still/', ajapaik.ajapaik_video.views.generate_still_from_video),
    # Legacy URLs
    ...
    path('photos/<int:page>/', views.frontpage, name='frontpage_photos'),
    path('photos/<int:album_id>/<int:page>/', views.frontpage, name='frontpage_photos'),
    ...
    path('curator/', ajapaik.ajapaik_curator.views.curator, name='curator'),
    path('curator-album-info/', ajapaik.ajapaik_curator.views.curator_get_album_info, name='curator_get_album_info'),
    path('curator-update-my-album/', ajapaik.ajapaik_curator.views.curator_update_my_album,
         name='curator_update_my_album'),
    path('curator-album-list/', ajapaik.ajapaik_curator.views.curator_my_album_list, name='curator_my_album_list'),
    path('curator-selectable-albums/', ajapaik.ajapaik_curator.views.curator_selectable_albums,
         name='curator_selectable_albums'),
    path('curator-search/', ajapaik.ajapaik_curator.views.curator_search, name='curator_search'),
    path('curator-upload/', ajapaik.ajapaik_curator.views.curator_photo_upload_handler,
    ...
    path('csv-import/', ajapaik.ajapaik_upload.csv_import.views.csv_import, name='csv_import'),
    path('submit-dating/', ajapaik.ajapaik_datings.views.submit_dating, name='submit_dating'),
    path('datings/<int:photo_id>/', ajapaik.ajapaik_datings.views.get_datings, name='get_datings'),
    path('donate/', ajapaik.ajapaik_misc.views.donate, name='donate'),
    path('choose-upload-action/', views.photo_upload_choice, name='photo_upload_choice'),
    path('user-upload/', ajapaik.ajapaik_upload.views.user_upload, name='user_upload'),
    path('user-upload-add-album/', ajapaik.ajapaik_upload.views.user_upload_add_album, name='user_upload_add_album'),
    path('privacy/', ajapaik.ajapaik_misc.views.privacy, name='privacy'),
    path('terms/', ajapaik.ajapaik_misc.views.terms, name='terms'),
    path('compare-photos/<int:photo_id>/<int:photo_id_2>/', ajapaik.ajapaik_similar_photos.views.compare_photos,
         name='compare-photos'),
    path('compare-all-photos/', ajapaik.ajapaik_similar_photos.views.compare_all_photos, name='compare-all-photos'),
    path('compare-all-photos/<int:photo_id>/<int:photo_id_2>/',
         ajapaik.ajapaik_similar_photos.views.compare_all_photos,
         name='compare-all-photos'),
    path('me/', ajapaik.ajapaik_profile.views.me, name='me'),
    path('user/<int:user_id>/', ajapaik.ajapaik_profile.views.user, name='user'),
    path('user/settings/', ajapaik.ajapaik_profile.views.user_settings, name='user_settings'),
    path('user/settings-modal/', ajapaik.ajapaik_profile.views.user_settings_modal, name='user_settings_modal'),
    path('user/merge-accounts/', ajapaik.ajapaik_profile.views.merge_accounts, name='merge_accounts'),
    path('photo-upload/settings-modal/', ajapaik.ajapaik_profile.views.rephoto_upload_settings_modal,
         name='rephoto_upload_settings_modal'),
    path('supporters/', ajapaik.ajapaik_misc.views.supporters, name='supporters'),
    path('accounts/launcher/', ajapaik.ajapaik_auth.views.oauthdone, name='oauthdone'),
]
...
urlpatterns += [
    ...
    path('api/v1/merge-profiles/', ajapaik.ajapaik_profile.api.MergeProfiles.as_view(), name='api_merge_users')
]
...
urlpatterns += [
    ...
    path('accounts/password/set/', ajapaik.ajapaik_profile.views.MyPasswordSetView.as_view(),
         name="account_set_password"),
    path('accounts/social/connections/', ajapaik.ajapaik_profile.views.MyConnectionsView.as_view(),
         name="socialaccount_connections"),
    path('accounts/', include(allauth_urls)),
    path('admin/', admin.site.urls),
    path('admin_tools/', include(admin_urls)),
    path('comments/for/<int:photo_id>/', ajapaik.ajapaik_comments.views.CommentList.as_view(),
         name='comments-for-photo'),
    path('comments/post-one/<int:photo_id>/', login_required(ajapaik.ajapaik_comments.views.PostComment.as_view()),
         name='comments-post-one'),
    path('comments/delete-one/', login_required(ajapaik.ajapaik_comments.views.DeleteComment.as_view()),
         name='comments-delete-one'),
    path('comments/edit-one/', login_required(ajapaik.ajapaik_comments.views.EditComment.as_view()),
         name='comments-edit-one'),
    path('comments/like-count/<int:comment_id>/', ajapaik.ajapaik_comments.views.get_comment_like_count,

...
urlpatterns = [
    ...
    url(r'^map-tablet/$', views.mapview, name='map'),
    url(r'^map-tablet/photo/(?P<photo_id>\d+)/$', views.mapview, name='map'),
    url(r'^map-tablet/rephoto/(?P<rephoto_id>\d+)/$', views.mapview, name='map'),
    url(r'^map-tablet/photo/(?P<photo_id>\d+)/rephoto/(?P<rephoto_id>\d+)/$', views.mapview, name='map'),

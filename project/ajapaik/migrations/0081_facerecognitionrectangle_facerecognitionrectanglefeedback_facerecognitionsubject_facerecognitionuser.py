    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('rectangle', models.ForeignKey(related_name='feedback', to='ajapaik.FaceRecognitionRectangle')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('rectangle', models.ForeignKey(related_name='guesses', to='ajapaik.FaceRecognitionRectangle')),
                ('subject', models.ForeignKey(related_name='guesses', to='ajapaik.FaceRecognitionSubject')),

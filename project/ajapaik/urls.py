...
urlpatterns = patterns('project.ajapaik.views',
   ...
   url(r'^upload/', include('applications.photos_upload.urls')),
)
...
urlpatterns += patterns('project.ajapaik.api',
    ...
    url(r'^api/v1/user/profile/$', api.UserProfile.as_view(), name='api_user_profile'),
    ...
    url(r'^api/v1/licences/list/$', api.LicenceList.as_view()),
)

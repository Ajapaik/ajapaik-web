...
class Dating(Model):
    ...
    start = DateField(default=datetime.strptime('01011000', '%d%m%Y').date(), blank=True, null=True)
    ...
    end = DateField(default=datetime.strptime('01013000', '%d%m%Y').date(), blank=True, null=True)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Guess.created'
        db.add_column('project_guess', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 2, 26), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Guess.created'
        db.delete_column('project_guess', 'created')

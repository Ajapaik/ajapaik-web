...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GeoTag.score'
        db.add_column('project_geotag', 'score', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GeoTag.score'
        db.delete_column('project_geotag', 'score')

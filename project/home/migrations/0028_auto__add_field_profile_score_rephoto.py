...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.score_rephoto'
        db.add_column(u'project_profile', 'score_rephoto',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.score_rephoto'
        db.delete_column(u'project_profile', 'score_rephoto')

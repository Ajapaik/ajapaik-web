...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.fb_hometown'
        db.add_column(u'project_profile', 'fb_hometown',
                      self.gf('django.db.models.fields.CharField')(max_length=511, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.fb_current_location'
        db.add_column(u'project_profile', 'fb_current_location',
                      self.gf('django.db.models.fields.CharField')(max_length=511, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.fb_birthday'
        db.add_column(u'project_profile', 'fb_birthday',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.fb_email'
        db.add_column(u'project_profile', 'fb_email',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.fb_user_friends'
        db.add_column(u'project_profile', 'fb_user_friends',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.fb_hometown'
        db.delete_column(u'project_profile', 'fb_hometown')

        # Deleting field 'Profile.fb_current_location'
        db.delete_column(u'project_profile', 'fb_current_location')

        # Deleting field 'Profile.fb_birthday'
        db.delete_column(u'project_profile', 'fb_birthday')

        # Deleting field 'Profile.fb_email'
        db.delete_column(u'project_profile', 'fb_email')

        # Deleting field 'Profile.fb_user_friends'
        db.delete_column(u'project_profile', 'fb_user_friends')
    ...
    models = {
        ...
        'project.photo': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'max_length': '2047', 'null': 'True', 'blank': 'True'}),
        ...
        'project.profile': {
            ...
            'fb_birthday': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'fb_current_location': ('django.db.models.fields.CharField', [], {'max_length': '511', 'null': 'True', 'blank': 'True'}),
            'fb_email': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'fb_hometown': ('django.db.models.fields.CharField', [], {'max_length': '511', 'null': 'True', 'blank': 'True'}),
            ...
            'fb_user_friends': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),

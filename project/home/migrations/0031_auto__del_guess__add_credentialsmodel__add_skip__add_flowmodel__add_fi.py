...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'project_guess')

        # Adding model 'CredentialsModel'
        db.create_table(u'project_credentialsmodel', (
        ...
        db.send_create_signal('project', ['CredentialsModel'])

        # Adding model 'Skip'
        db.create_table(u'project_skip', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='skips', to=orm['project.Profile'])),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.Photo'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('project', ['Skip'])

        # Adding model 'FlowModel'
        db.create_table(u'project_flowmodel', (
            ('id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], primary_key=True)),
            ('flow', self.gf('oauth2client.django_orm.FlowField')(null=True)),
        ))
        db.send_create_signal('project', ['FlowModel'])

        # Adding field 'Photo.bounding_circle_radius'
        db.add_column(u'project_photo', 'bounding_circle_radius',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.azimuth'
        db.add_column(u'project_photo', 'azimuth',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.azimuth_confidence'
        db.add_column(u'project_photo', 'azimuth_confidence',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Profile.google_plus_id'
        db.add_column(u'project_profile', 'google_plus_id',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.google_plus_link'
        db.add_column(u'project_profile', 'google_plus_link',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.google_plus_name'
        db.add_column(u'project_profile', 'google_plus_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.google_plus_token'
        db.add_column(u'project_profile', 'google_plus_token',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.google_plus_picture'
        db.add_column(u'project_profile', 'google_plus_picture',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'GeoTag.azimuth'
        db.add_column(u'project_geotag', 'azimuth',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GeoTag.zoom_level'
        db.add_column(u'project_geotag', 'zoom_level',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GeoTag.azimuth_score'
        db.add_column(u'project_geotag', 'azimuth_score',
    ...
    def backwards(self, orm):
        # Adding model 'Guess'
        db.create_table(u'project_guess', (
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.Photo'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='guesses', to=orm['project.Profile'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'project', ['Guess'])

        # Deleting model 'CredentialsModel'
        db.delete_table(u'project_credentialsmodel')

        # Deleting model 'Skip'
        db.delete_table(u'project_skip')

        # Deleting model 'FlowModel'
        db.delete_table(u'project_flowmodel')

        # Deleting field 'Photo.bounding_circle_radius'
        db.delete_column(u'project_photo', 'bounding_circle_radius')

        # Deleting field 'Photo.azimuth'
        db.delete_column(u'project_photo', 'azimuth')

        # Deleting field 'Photo.azimuth_confidence'
        db.delete_column(u'project_photo', 'azimuth_confidence')

        # Deleting field 'Profile.google_plus_id'
        db.delete_column(u'project_profile', 'google_plus_id')

        # Deleting field 'Profile.google_plus_link'
        db.delete_column(u'project_profile', 'google_plus_link')

        # Deleting field 'Profile.google_plus_name'
        db.delete_column(u'project_profile', 'google_plus_name')

        # Deleting field 'Profile.google_plus_token'
        db.delete_column(u'project_profile', 'google_plus_token')

        # Deleting field 'Profile.google_plus_picture'
        db.delete_column(u'project_profile', 'google_plus_picture')

        # Deleting field 'GeoTag.azimuth'
        db.delete_column(u'project_geotag', 'azimuth')

        # Deleting field 'GeoTag.zoom_level'
        db.delete_column(u'project_geotag', 'zoom_level')

        # Deleting field 'GeoTag.azimuth_score'
        db.delete_column(u'project_geotag', 'azimuth_score')
    ...
    models = {
        ...
        'project.photo': {
            ...
            'image_unscaled': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),

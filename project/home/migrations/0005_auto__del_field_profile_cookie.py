...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.cookie'
        db.delete_column('project_profile', 'cookie')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Profile.cookie'
        raise RuntimeError("Cannot reverse this migration. 'Profile.cookie' and its values cannot be restored.")

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Album'
        db.create_table('project_album', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('atype', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='albums', null=True, to=orm['project.Profile'])),
        ...
        db.send_create_signal('project', ['Album'])

        # Adding model 'AlbumPhoto'
        db.create_table('project_albumphoto', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('album', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.Album'])),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.Photo'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('project', ['AlbumPhoto'])


    def backwards(self, orm):
        # Deleting model 'Album'
        db.delete_table('project_album')

        # Deleting model 'AlbumPhoto'
        db.delete_table('project_albumphoto')

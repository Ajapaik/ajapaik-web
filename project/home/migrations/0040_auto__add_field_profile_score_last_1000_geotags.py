...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.score_last_1000_geotags'
        db.add_column(u'project_profile', 'score_last_1000_geotags',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.score_last_1000_geotags'
        db.delete_column(u'project_profile', 'score_last_1000_geotags')

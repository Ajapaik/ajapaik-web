...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'project_photo', 'description', self.gf('django.db.models.fields.TextField')(max_length=2047, null=True))

    def backwards(self, orm):

        # Changing field 'Photo.description'
        db.alter_column(u'project_photo', 'description', self.gf('django.db.models.fields.TextField')(null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DifficultyFeedback.trustworthiness'
        db.add_column(u'project_difficultyfeedback', 'trustworthiness',
                      self.gf('django.db.models.fields.FloatField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DifficultyFeedback.trustworthiness'
        db.delete_column(u'project_difficultyfeedback', 'trustworthiness')

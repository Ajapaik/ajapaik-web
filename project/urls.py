...
urlpatterns = patterns('project.home.views',
   ...
   url(r'^update_comment_counts/', 'update_comment_counts'),
   ...
   url(r'^photos/(?P<order>.*)/$', 'frontpage', name='frontpage_photos'),
   url(r'^photos/(?P<page>\d+)/$', 'frontpage', name='frontpage_photos'),
   url(r'^photos/(?P<page>\d+)/(?P<order>.*)/$', 'frontpage', name='frontpage_photos'),
   url(r'^photos/(?P<album_id>\d+)/(?P<page>\d+)/$', 'frontpage', name='frontpage_photos'),
   url(r'^photos/(?P<album_id>\d+)/(?P<page>\d+)/(?P<order>.*)/$', 'frontpage', name='frontpage_photos'),
   url(r'^grid/$', 'grid'),

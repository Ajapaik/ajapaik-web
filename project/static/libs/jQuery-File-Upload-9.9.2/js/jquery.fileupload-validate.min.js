...
acceptFileTypes:"File type not allowed",maxFileSize:"File is too large",minFileSize:"File is too small"}},processActions:{validate:function(d,b){if(b.disabled)return d;var g=a.Deferred(),e=this.options,c=d.files[d.index],f;if(b.minFileSize||b.maxFileSize)f=c.size;"number"===a.type(b.maxNumberOfFiles)&&(e.getNumberOfFiles()||0)+d.files.length>b.maxNumberOfFiles?c.error=e.i18n("maxNumberOfFiles"):!b.acceptFileTypes||b.acceptFileTypes.test(c.type)||b.acceptFileTypes.test(c.name)?f>b.maxFileSize?c.error=
e.i18n("maxFileSize"):"number"===a.type(f)&&f<b.minFileSize?c.error=e.i18n("minFileSize"):delete c.error:c.error=e.i18n("acceptFileTypes");c.error||d.files.error?(d.files.error=!0,g.rejectWith(this,[d])):g.resolveWith(this,[d]);return g.promise()}}})});
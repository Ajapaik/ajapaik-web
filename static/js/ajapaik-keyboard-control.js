(function ($) {
    ...
    $.jQee = function (keys, cb) {
        ...
        $.each(['click', 'dblclick', 'hover', 'mousedown', 'mouseenter', 'mouseleave', 'tapone', 'taptwo', 'tapthree',
                'swipe', 'mousemove', 'mouseout', 'mouseover', 'mouseup', 'contextmenu', 'swipeup', 'swipedown',
                'swipeleft', 'swiperight', 'swiperightup', 'swiperightdown', 'swipeleftup', 'swipeleftdown', 'swipeone',
                'swipetwo', 'swipethree', 'swipefour', 'swipemove', 'orientationchange', 'pinch', 'rotate'],
            function (k, e) {
                if (/textarea|select/i.test($(o.selector).get(0).tagName) || $(o.selector).is('[type=text]') ||
                        $(o.selector).prop('contenteditable') == 'true') {
                    $.noop();
                } else {
                ...
                if (o.keys.indexOf(e.toLowerCase()) != -1) {
                    $(o.selector).bind(e, o.callback);
                }
            });
            ...
            add: function (obj) {
                ...
                obj.handler = function (event) {
                    ...
                    if (special) {
                        ...
                        if (modif === 'shift+') {
                            possible[$.jQee.shiftMap[character]] = true;
                        }
                    }

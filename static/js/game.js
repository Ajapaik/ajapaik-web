(function ($) {
    ...
    nextPhoto = function () {
        ...
        $.getJSON(streamUrl, $.extend({'album': window.albumId, 'b': new Date().getTime(), csrfmiddlewaretoken: window.docCookies.getItem('csrftoken')}, window.URI.parseQuery(window.location.search)), function (data) {

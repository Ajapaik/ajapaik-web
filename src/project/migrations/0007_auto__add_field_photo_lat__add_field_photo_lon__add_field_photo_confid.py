...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.lat'
        db.add_column('project_photo', 'lat', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Photo.lon'
        db.add_column('project_photo', 'lon', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Photo.confidence'
        db.add_column('project_photo', 'confidence', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.lat'
        db.delete_column('project_photo', 'lat')

        # Deleting field 'Photo.lon'
        db.delete_column('project_photo', 'lon')

        # Deleting field 'Photo.confidence'
        db.delete_column('project_photo', 'confidence')

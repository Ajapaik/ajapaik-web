...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.cam_scale_factor'
        db.add_column('project_photo', 'cam_scale_factor',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.cam_yaw'
        db.add_column('project_photo', 'cam_yaw',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.cam_pitch'
        db.add_column('project_photo', 'cam_pitch',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.cam_roll'
        db.add_column('project_photo', 'cam_roll',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.cam_scale_factor'
        db.delete_column('project_photo', 'cam_scale_factor')

        # Deleting field 'Photo.cam_yaw'
        db.delete_column('project_photo', 'cam_yaw')

        # Deleting field 'Photo.cam_pitch'
        db.delete_column('project_photo', 'cam_pitch')

        # Deleting field 'Photo.cam_roll'
        db.delete_column('project_photo', 'cam_roll')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FlipFeedback'
        db.create_table(u'project_flipfeedback', (
            ...
            ('flip', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'project', ['FlipFeedback'])

        # Adding field 'Photo.flip'
        db.add_column(u'project_photo', 'flip',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DifficultyFeedback.created'
        db.add_column(u'project_difficultyfeedback', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 9, 11, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'FlipFeedback'
        db.delete_table(u'project_flipfeedback')

        # Deleting field 'Photo.flip'
        db.delete_column(u'project_photo', 'flip')

        # Deleting field 'DifficultyFeedback.created'
        db.delete_column(u'project_difficultyfeedback', 'created')

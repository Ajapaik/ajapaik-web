...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GeoTag.is_correct'
        db.add_column('project_geotag', 'is_correct', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GeoTag.is_correct'
        db.delete_column('project_geotag', 'is_correct')

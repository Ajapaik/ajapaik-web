...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserMapView'
        db.create_table(u'project_usermapview', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.Photo'])),
            ('user_profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.Profile'])),
        ...
        db.send_create_signal('project', ['UserMapView'])


    def backwards(self, orm):
        # Deleting model 'UserMapView'
        db.delete_table(u'project_usermapview')
    ...
    models = {
        ...
        'project.profile': {
            ...
            'score_last_1000_geotags': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),

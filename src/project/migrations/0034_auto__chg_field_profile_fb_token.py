...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.fb_token'
        db.alter_column(u'project_profile', 'fb_token', self.gf('django.db.models.fields.CharField')(max_length=511, null=True))

    def backwards(self, orm):

        # Changing field 'Profile.fb_token'
        db.alter_column(u'project_profile', 'fb_token', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Album.sort_order'
        db.delete_column('project_album', 'sort_order')

        # Adding field 'AlbumPhoto.sort_order'
        db.add_column('project_albumphoto', 'sort_order',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Album.sort_order'
        db.add_column('project_album', 'sort_order',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'AlbumPhoto.sort_order'
        db.delete_column('project_albumphoto', 'sort_order')

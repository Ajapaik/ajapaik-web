...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('project_profile', 'user_ptr_id')

        # Adding field 'Profile.user'
        db.add_column('project_profile', 'user', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['auth.User'], unique=True, primary_key=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('project_profile', 'user_id')

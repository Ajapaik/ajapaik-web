...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.image_unscaled'
        db.add_column(u'project_photo', 'image_unscaled',
                      self.gf('sorl.thumbnail.fields.ImageField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.image_unscaled'
        db.delete_column(u'project_photo', 'image_unscaled')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GeoTag.trustworthiness'
        db.add_column('project_geotag', 'trustworthiness', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GeoTag.trustworthiness'
        db.delete_column('project_geotag', 'trustworthiness')

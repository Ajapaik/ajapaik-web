...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Photo.city'
        db.alter_column('project_photo', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['project.City']))


    def backwards(self, orm):
        
        # Changing field 'Photo.city'
        db.alter_column('project_photo', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.City'], null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DifficultyFeedback'
        db.create_table(u'project_difficultyfeedback', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photo', to=orm['project.Photo'])),
            ('user_profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='profile', to=orm['project.Profile'])),
            ('level', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal(u'project', ['DifficultyFeedback'])


        # Changing field 'Photo.image'
        db.alter_column(u'project_photo', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Photo.image_unscaled'
        db.alter_column(u'project_photo', 'image_unscaled', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting model 'DifficultyFeedback'
        db.delete_table(u'project_difficultyfeedback')


        # Changing field 'Photo.image'
        db.alter_column(u'project_photo', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=200, null=True))

        # Changing field 'Photo.image_unscaled'
        db.alter_column(u'project_photo', 'image_unscaled', self.gf('sorl.thumbnail.fields.ImageField')(max_length=200, null=True))
    ...
    models = {
        ...
        u'project.difficultyfeedback': {
            'Meta': {'object_name': 'DifficultyFeedback'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'photo': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photo'", 'to': "orm['project.Photo']"}),
            'user_profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'profile'", 'to': "orm['project.Profile']"})
        },
        'project.flowmodel': {

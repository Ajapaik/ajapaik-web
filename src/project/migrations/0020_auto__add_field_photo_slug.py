...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('project_photo', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.slug'
        db.delete_column('project_photo', 'slug')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GeoTag.user'
        db.add_column('project_geotag', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['project.User']), keep_default=False)

        # Adding field 'GeoTag.photo'
        db.add_column('project_geotag', 'photo', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['project.Photo']), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Photo.image'
        db.alter_column('project_photo', 'image', self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True))

        # Deleting field 'GeoTag.user'
        db.delete_column('project_geotag', 'user_id')

        # Deleting field 'GeoTag.photo'
        db.delete_column('project_geotag', 'photo_id')

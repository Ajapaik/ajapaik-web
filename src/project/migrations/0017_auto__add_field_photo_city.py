...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.city'
        db.add_column('project_photo', 'city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.City'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.city'
        db.delete_column('project_photo', 'city_id')
    ...
    models = {
        ...
        'project.photo': {
            ...
            'city': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['project.City']", 'null': 'True', 'blank': 'True'}),

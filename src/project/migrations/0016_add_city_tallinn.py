...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.City(name='Tallinn',lat=59.435474,lon=24.750309).save()
        orm.City(name='Tartu',lat=58.376713,lon=26.726168).save()
        orm.City(name=u'P\xe4rnu',lat=58.384106,lon=24.499467).save()
        orm.City(name='Viljandi',lat=58.367189,lon=25.598453).save()
        orm.City(name='Narva',lat=59.372147,lon=28.190565).save()

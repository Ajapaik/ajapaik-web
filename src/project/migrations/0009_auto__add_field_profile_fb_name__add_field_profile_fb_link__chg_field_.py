...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.fb_name'
        db.add_column('project_profile', 'fb_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.fb_link'
        db.add_column('project_profile', 'fb_link', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Changing field 'Profile.fb_id'
        db.alter_column('project_profile', 'fb_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Profile.fb_name'
        db.delete_column('project_profile', 'fb_name')

        # Deleting field 'Profile.fb_link'
        db.delete_column('project_profile', 'fb_link')

        # Changing field 'Profile.fb_id'
        db.alter_column('project_profile', 'fb_id', self.gf('django.db.models.fields.IntegerField')(null=True))

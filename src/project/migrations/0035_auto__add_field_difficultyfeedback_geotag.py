...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DifficultyFeedback.geotag'
        db.add_column(u'project_difficultyfeedback', 'geotag',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='geotag', to=orm['project.GeoTag']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DifficultyFeedback.geotag'
        db.delete_column(u'project_difficultyfeedback', 'geotag_id')
    ...
    models = {
        ...
        'project.difficultyfeedback': {
            ...
            'geotag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'geotag'", 'to': "orm['project.GeoTag']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
